...
function generateMaterials () {
  ...
  var hatchingMaterial2 = createShaderMaterial('hatching', light, ambientLight)

  var dottedMaterial = createShaderMaterial('dotted', light, ambientLight)

  var dottedMaterial2 = createShaderMaterial('dotted', light, ambientLight)
...
function setupGui () {
  var createHandler = function (id) {
    return function () {
      ...
      effect.enableColors = current_material === 'colors'
    }
  }
...
function render () {
  ...
  if (effect.material instanceof THREE.ShaderMaterial) {
    if (current_material === 'dotted2') {
      effect.material.uniforms['uLineColor1'].value.setHSL(
      ...
      u.uLineColor4.value.setHSL(
        effectController.hue + (0.2 % 1.0),
        effectController.saturation,
        effectController.lightness
      )
    } else {
